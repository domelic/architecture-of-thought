...
Developed by German sociologist Niklas Luhmann (who published over 70 books and 400 articles using this system), Zettelkasten (``slip box'') emphasizes:
...
Tiago Forte's PARA (Projects, Areas, Resources, Archives) offers an action-oriented organizational structure:
...
In 1998, philosophers Andy Clark and David Chalmers published a landmark paper in \emph{Analysis} titled ``The Extended Mind,'' posing a provocative question: \emph{Where does the mind stop and the rest of the world begin?}
...
Clark continued developing the extended mind thesis in subsequent work. His 2008 book \emph{Supersizing the Mind} and 2015's \emph{Surfing Uncertainty} extended the framework, arguing that humans are ``natural-born cyborgs''---creatures whose minds have always been constituted partly by external scaffolding, from language itself to written records to digital devices.
...
While Clark and Chalmers focused on individual minds extending into the environment, cognitive scientist Edwin Hutchins asked a different question: what if we took the \emph{system} rather than the individual as our unit of cognitive analysis?

\section{Cognition in the Wild}

In his 1995 book \emph{Cognition in the Wild}, Hutchins presented an ethnographic study of navigation aboard a U.S. Navy ship. Rather than examining how individual sailors think, he treated the entire bridge---its crew, instruments, charts, and procedures---as a single cognitive system.
...
The third theoretical pillar of DCF comes from developmental psychology. Soviet psychologist Lev Vygotsky (1896--1934) developed ideas about learning and development that, though nearly a century old, speak directly to human-AI collaboration.

\section{The Zone of Proximal Development}

Vygotsky's most influential concept is the \textbf{Zone of Proximal Development} (ZPD):
...
While Vygotsky introduced the ZPD, the term ``scaffolding'' was coined later by Jerome Bruner, David Wood, and Gail Ross in 1976. They observed tutors helping children with a construction task and noticed a pattern:
...
A 2025 framework by Riedl and Weidmann proposes a ``Synergy Index'' for measuring human-AI partnership effectiveness through multiple variables:
...
A 2024 meta-analysis in \emph{Nature Human Behaviour} titled ``When Combinations of Humans and AI Are Useful'' provides important context:
...
\section{The Emergence of New Terms (2024--2025)}

The field is rapidly developing vocabulary, with several terms gaining traction:
